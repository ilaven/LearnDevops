...
export class SchedularPopup implements OnInit, AfterViewInit {
  ...
  constructor(private dialogRef: MatDialogRef<SchedularPopup>, @Optional() @Inject(MAT_DIALOG_DATA) public data: any,
    private httpOntracService: HttpOntracService, private cookiesService: CookiesService, public dialog: MatDialog,
  ...
  module1_creationCompleteHandler() {
    ...
    this.httpOntracService.fetchReportScheduler(t001ClientObj).subscribe({
      next: (result) => {
        this.ReportSchedulerResult(result);
