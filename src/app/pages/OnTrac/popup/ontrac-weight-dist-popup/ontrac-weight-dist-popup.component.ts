...
@Component({
  selector: 'app-ontrac-weight-dist-popup',
  templateUrl: './ontrac-weight-dist-popup.component.html',
  styleUrls: ['ontrac-weight-dist-popup.component.css'],
  standalone: false
})
export class OntracWeightDistPopupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<OntracWeightDistPopupComponent>,
  ...
  serviceType: any;
  t004ChargeObj = {};
  async fetchByServices(currentYear: any, clickedMonth: any) {
    await this.fetchBy_Services();
  ...
  async bar_chart0(tempAC: any, weightchargetype: any) {
  ...
  async createSeriesFromAC_bar(collection: any, weightchargetype: String, nameField: String, yField: String) {
    ...
    var chartData = [
      {
        "weight": "<1",
        "value": tempObj.averageCostLtr ? tempObj.averageCostLtr : '0'
      },
      {
        "weight": "1",
  ...
  async createSeriesFromAC_bar31(collection: any, weightchargetype: String) {
    ...
    var chartData = [
      {
        "weight": "<1",
        "value": tempObj.netChargeLtr ? tempObj.netChargeLtr : '0'
      },
      {
        "weight": "1",
  ...
  async createSeriesFromAC2(collection: any, weightchargetype: String, seriesName: String) {
    ...
    var chartData = [
      {
        "weight": "<1",
        "value": tempObj.volumeLtr ? tempObj.volumeLtr : '0'
      },
      {
        "weight": "1",
  ...
  async fetchServiceByAcc() {
    await this.httpOntracService.fetchSpendByAccountNumber(this.moreviewWeightFormGroup.value)?.subscribe(
      (result: any) => {
  ...
  async fetchBy_Services() {
    await this.httpOntracService.fetchByServiceByWeight(this.moreviewWeightFormGroup.value)?.subscribe(
      (result: any) => {
        this.resultObj = result;
  ...
  async createSeriesFromAC_bar3(collection: any) {
    ...
    for (var loopValue = 0; loopValue < outerNumber; loopValue++) {
      ...
      var charDesc = tempObj.groupBy;

      if (tempObj != null && this.weightchargetype == tempObj.chargeType) {
        var chargeName = charDesc;
        chargeName_val.push(chargeName);
        chartDataChild1.push(tempObj.netChargeLtr ? tempObj.netChargeLtr : '0');
        chartDataChild2.push(tempObj.netCharge1Lbs ? tempObj.netCharge1Lbs : '0');
        chartDataChild3.push(tempObj.netCharge2Lbs ? tempObj.netCharge2Lbs : '0');
        chartDataChild4.push(tempObj.netCharge3Lbs ? tempObj.netCharge3Lbs : '0');
        chartDataChild5.push(tempObj.netCharge4Lbs ? tempObj.netCharge4Lbs : '0');
        chartDataChild6.push(tempObj.netCharge5Lbs ? tempObj.netCharge5Lbs : '0');
        chartDataChild7.push(tempObj.netCharge6to10Lbs ? tempObj.netCharge6to10Lbs : '0');
        chartDataChild8.push(tempObj.netCharge11to20Lbs ? tempObj.netCharge11to20Lbs : '0');
        chartDataChild9.push(tempObj.netCharge21to30Lbs ? tempObj.netCharge21to30Lbs : '0');
        chartDataChild10.push(tempObj.netCharge31to50Lbs ? tempObj.netCharge31to50Lbs : '0');
        chartDataChild11.push(tempObj.netCharge51to70Lbs ? tempObj.netCharge51to70Lbs : '0');
        chartDataChild12.push(tempObj.netCharge71to150Lbs ? tempObj.netCharge71to150Lbs : '0');
        chartDataChild13.push(tempObj.netCharge150PlusLbs ? tempObj.netCharge150PlusLbs : '0');
      }
    }

    chartData = chartDataChild1;
