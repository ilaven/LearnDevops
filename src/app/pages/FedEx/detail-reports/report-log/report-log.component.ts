 ...
 * Create Component
 */
export class FedexReportLogComponent implements OnInit {
  ...
  constructor(private loaderService: LoaderService, private cookiesService: CookiesService,
    private httpFedexService: HttpfedexService, public dialog: MatDialog, private commonService: CommonService, public dialogRef: MatDialogRef<FedexReportLogComponent>,
  ...
  loadUser() {
    this.httpFedexService.fetchReportData(this.clientProfile).subscribe({
      next: (result) => {
