...
@Component({
  selector: 'app-fedex-serviceby-weight-popup',
  templateUrl: './fedex-serviceby-weight.component.html',
   standalone: false
})
export class FedexServiceByWeightPopupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<FedexServiceByWeightPopupComponent>,
