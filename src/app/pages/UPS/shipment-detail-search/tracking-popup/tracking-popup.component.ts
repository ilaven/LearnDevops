...
import { Component, OnInit, Optional, Inject, ChangeDetectorRef, HostListener } from "@angular/core";
...
export class TrackingPopupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<TrackingPopupComponent>, private httpClientService: HttpClientService, private datePipe: DatePipe,
    private commonService: CommonService, private dialog: MatDialog, private cd: ChangeDetectorRef,
