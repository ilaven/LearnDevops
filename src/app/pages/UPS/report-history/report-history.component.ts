...
@Component({
  selector: 'app-ups-report-history',
 ...
 * Create Component
 */
export class UpsReportHistoryComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  reportLog_clickHandler(param: any) {
    ...
    this.httpClientService.fetchReportLog(userprofile).subscribe({
      next: result => {
