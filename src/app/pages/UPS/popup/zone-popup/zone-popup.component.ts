...
@Component({
	...
	styleUrls: ['./zone-popup.component.css'],
	standalone: false
})
export class ZonePopupComponent implements OnInit {
	...
	constructor(private commonService: CommonService, public dialog: MatDialog,
		public dialogRef: MatDialogRef<ZonePopupComponent>, private mlForm: UntypedFormBuilder, private cd: ChangeDetectorRef, private httpClientService: HttpClientService, private zone: NgZone,
