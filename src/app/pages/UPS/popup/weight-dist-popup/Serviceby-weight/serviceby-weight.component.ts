...
@Component({
  selector: 'app-serviceby-weight-popup',
  templateUrl: './serviceby-weight.component.html',
   standalone: false
})
export class ServiceByWeightPopupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ServiceByWeightPopupComponent>,
