 ...
 * Create Component
 */
export class UpsReportLogComponent implements OnInit {
  ...
  constructor(private loaderService: LoaderService, private cookiesService: CookiesService,
    private httpClientService: HttpClientService, public dialog: MatDialog, private commonService: CommonService, public dialogRef: MatDialogRef<UpsReportLogComponent>,
  ...
  loadUser() {
    this.httpClientService.fetchReportLog(this.clientProfile).subscribe({
      next: (result) => {
