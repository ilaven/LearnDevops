 ...
 * Create Component
 */
export class DhlReportLogComponent implements OnInit {
  ...
  constructor(private loaderService: LoaderService, private cookiesService: CookiesService,
    private httpDhlService: HttpDhlService, public dialog: MatDialog, private commonService: CommonService, public dialogRef: MatDialogRef<DhlReportLogComponent>,
  ...
  loadUser() {
    this.httpDhlService.fetchReportLog(this.clientProfile).subscribe({
      next: (result) => {
