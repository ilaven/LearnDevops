...
@Component({
  selector: 'app-dhl-serviceby-weight-popup',
  templateUrl: './dhl-serviceby-weight.component.html',
   standalone: false
})
export class DhlServiceByWeightPopupComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DhlServiceByWeightPopupComponent>,
