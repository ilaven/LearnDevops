...
@Component({
  selector: 'app-accessorial-popup',
  templateUrl: './accessorial-popup.component.html',
  styleUrls: ['./accessorial-popup.component.css'],
  standalone: false
})
export class AccessorialPopupComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AccessorialPopupComponent>, private httpClientService: HttpClientService, private cookiesService: CookiesService,
