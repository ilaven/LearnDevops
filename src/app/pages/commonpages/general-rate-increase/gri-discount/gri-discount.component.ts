...
@Component({
  selector: 'app-gri-discount',
  templateUrl: './gri-discount.component.html',
  styleUrls: ['./gri-discount.component.css'],
  standalone: false
})


export class GRIdiscountComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<GRIdiscountComponent>, private dialog: MatDialog, private httpClientService: HttpClientService, private cookiesService: CookiesService,
