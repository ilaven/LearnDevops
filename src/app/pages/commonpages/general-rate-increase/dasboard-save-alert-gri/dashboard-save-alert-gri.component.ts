...
@Component({
  selector: 'app-dashboard-save-alert-gri',
  templateUrl: './dashboard-save-alert-gri.component.html',
  standalone: false
})
export class DashBoardSaveAlertGRIComponent implements OnInit {
  message = '';
  targetName = '';
  type = "";
  proposalName = "";
  ...
  targetId: any;
  saveClicked = false;
  constructor(public dialogRef: MatDialogRef<DashBoardSaveAlertGRIComponent>, @Inject(MAT_DIALOG_DATA) private data: any) {
