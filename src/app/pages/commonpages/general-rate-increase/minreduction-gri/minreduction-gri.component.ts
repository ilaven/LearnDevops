...
import { MinreductiondetailGRIComponent } from "./minreductiondetail-gri/minreductiondetail-gri.component";
import { LoaderService } from "src/app/core/services/loader.service";

@Component({
  selector: 'app-minreduction-gri',
  templateUrl: './minreduction-gri.component.html',
  styleUrls: ['./minreduction-gri.component.css'],
  standalone: false
})
export class MinReductionGRIComponent implements OnInit {
  editable = false;
  ...
  service;
  serviceType;
  isOrderChanged = false; adminFlag: any;
  constructor(public dialogRef: MatDialogRef<MinReductionGRIComponent>, private loaderService: LoaderService, public dialog: MatDialog, private cd: ChangeDetectorRef,
  ...
  async popMinReduction(subGroup: any, type: any, carrierName: any, id: any, year: any) {
    ...
    const dialogRef = this.dialog.open(MinreductiondetailGRIComponent, {
      disableClose: true,
      width: "86%",
      height: "86%",
      panelClass: this.panelClass,
      data: { service: subGroup, targetIdList: targetId, carrier: this.carrierName, fedexId: this.data.fedexId, targetId: id, type: type, carrierName: carrierName, year: year }
    });
  }
